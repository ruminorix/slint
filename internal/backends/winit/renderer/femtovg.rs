...
impl WinitCompatibleRenderer for WGPUFemtoVGRenderer {
    ...
    fn resume(
        ...
        #[cfg(not(target_arch = "wasm32"))]
        {
            ...
            // (the WGPU FemtoVG renderer is meant to use modern backends).
            let (instance, adapter, device, queue, surface) =
                i_slint_core::graphics::wgpu_28::init_instance_adapter_device_queue_surface(
                    window_handle,
                    requested_graphics_api,
                    i_slint_core::graphics::wgpu_28::wgpu::Backends::GL,
                )
                .map_err(|e| PlatformError::from(format!("WGPU initialization failed: {e}")))?;
            finalize_wgpu_init(
                &window_adapter_weak,
        ...
        wasm_bindgen_futures::spawn_local(async move {
            ...
            // Chromium on CI).
            let init = wgpu_28::async_init_instance_adapter_device_queue_surface(
                window_handle,
                requested_graphics_api,
                wgpu_28::wgpu::Backends::empty(),
            )
            .await;
...
fn finalize_wgpu_init(
    ...
    instance: i_slint_core::graphics::wgpu_28::wgpu::Instance,
    adapter: i_slint_core::graphics::wgpu_28::wgpu::Adapter,
    device: i_slint_core::graphics::wgpu_28::wgpu::Device,
    queue: i_slint_core::graphics::wgpu_28::wgpu::Queue,
    surface: i_slint_core::graphics::wgpu_28::wgpu::Surface<'static>,
    ...
    let slint_size = crate::winitwindowadapter::physical_size_to_slint(&winit_window.inner_size());
    this.renderer
        .configure_surface_from_init_result(instance, adapter, device, queue, surface, slint_size);
